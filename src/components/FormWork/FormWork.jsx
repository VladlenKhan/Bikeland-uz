    ...
    <div className={styles.container}>
      <div className={styles.wrapper}>
        ...
        <div className={styles.block2}>
          <div className={styles.block2__title}>Расскажите о себе</div>
          <form className={styles.block2__form}>
            <div className={styles.item}>
              ...
              <div className={styles.block2__elem}>
                <label htmlFor="10" >Расскажите о себе, чем занимаетесь и какими навыками <br /> обладаете</label>
                <input
                  type="text"
                  id="10"
                  placeholder="Я умею..."
            ...
            <div className={styles.button}>
              <a href="#" className={styles.button__link}>
              Отправить
              </a>
            </div>
          </form>
