...
const Card = () => {
  ...
  const heartClassName = `${styles.card__heart} ${
    heartClicked ? styles.clicked : ""
  }`;
    ...
    <div className={styles.card}>
      ...
      <div className={styles.card__block}>
        ...
        <p className={styles.card__desc}>
          Аэродинамический обвес Superleggera превосходит не только доступные
          опции для Panigale V4 и V4 R, но и даже ...
        </p>
        <p className={styles.card__price}>20 880 000 UZS</p>
        <div className={styles.card__buttons}>
          <a href="#" className={styles.card__button_outline}>
            Смотреть подробнее
          </a>
          <a href="#" className={styles.card__button_red}>
            Заказать
          </a>
        </div>
      </div>
